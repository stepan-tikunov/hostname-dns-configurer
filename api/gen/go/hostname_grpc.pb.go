...
const (
	HostnameService_SetHostname_FullMethodName = "/api.HostnameService/SetHostname"
	HostnameService_GetHostname_FullMethodName = "/api.HostnameService/GetHostname"
)
...
var HostnameService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.HostnameService",
